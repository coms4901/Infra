...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 30 02:18:17 2021
...
class ROBOT:
    ...
    def send_joints(self,sim):
        self.J = {}
        self.J[0] = sim.send_hinge_joint(first_body_id=self.O[0], second_body_id=self.O[1], x=0, y=c.L/2, z=c.L+c.R, n1=-1, n2=0, n3=0, lo=-3.14159/2 , hi=3.14159/2)
        self.J[1] = sim.send_hinge_joint(first_body_id=self.O[1], second_body_id=self.O[5], x=0, y=1.5*c.L, z=c.L+c.R, n1=-1, n2=0, n3=0)
        self.J[2] = sim.send_hinge_joint(first_body_id=self.O[0], second_body_id=self.O[2], x=c.L/2, y=0, z=c.L+c.R, n1=0, n2=1, n3=0, lo=-3.14159/2 , hi=3.14159/2)
        self.J[3] = sim.send_hinge_joint(first_body_id=self.O[2], second_body_id=self.O[6], x=1.5*c.L, y=0, z=c.L+c.R, n1=0, n2=1, n3=0)
        self.J[4] = sim.send_hinge_joint(first_body_id=self.O[0], second_body_id=self.O[3], x=0, y=-c.L/2, z=c.L+c.R, n1=1, n2=0, n3=0, lo=-3.14159/2 , hi=3.14159/2)
        self.J[5] = sim.send_hinge_joint(first_body_id=self.O[3], second_body_id=self.O[7], x=0, y=-1.5*c.L, z=c.L+c.R, n1=1, n2=0, n3=0)
        self.J[6] = sim.send_hinge_joint(first_body_id=self.O[0], second_body_id=self.O[4], x=-c.L/2, y=0, z=c.L+c.R, n1=0, n2=-1, n3=0, lo=-3.14159/2 , hi=3.14159/2)
    ...
    def send_neurons(self,sim):
        ...
        self.MN = {}
        for j in self.J:
            self.MN[j] = sim.send_motor_neuron(joint_id=self.J[j], tau=0.3) #lower tau makes it less energetic; essentially less smoother (less of difference from one frame to the next), but also slower
